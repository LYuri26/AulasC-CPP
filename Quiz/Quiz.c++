...
int main()
{
    ...
    Group grupo3{"Grupo 3",
                 {{"Como se insere um valor 'x' no final de um vetor chamado 'vec'?", {"a) vec.add(x);", "b) vec.insert(x, vec.size());", "c) vec.push_back(x);", "d) vec.append(x);"}, 'c'},
                  {"Qual é o operador utilizado para obter o endereço de uma variável em C++?", {"a) &", "b) *", "c) %", "d) #"}, 'a'},
                  {"Qual é o tipo de dado que pode armazenar caracteres individuais em C++?", {"a) char", "b) string", "c) character", "d) character_array"}, 'a'},
                  {"Qual é o operador usado para ler um caractere único em C++?", {"a) get()", "b) char()", "c) read()", "d) cin >>"}, 'a'}}};
    ...
    do
    {
        ...
        case 2:
            ...
            break;
        case 3:
            runQuiz(grupo3, pontuacaoGrupo3);
            break;
        case 4:
        ...
        case 5:
            ...
            cout << "Pontuação do Grupo 3: " << pontuacaoGrupo3 << endl;
